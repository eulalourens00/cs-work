    ...
    public partial class MainPage : ContentPage
    {
        ...
        private void OnPatternChanged(object sender, EventArgs e)
        {
            if (sender is Button button)
            {
                ...
                if (pattern == "none")
                {
                    PatternImage.IsVisible = false;
                }
                else if (patterns.TryGetValue(pattern, out var patternFile))
                {
                    PatternImage.Source = patternFile;
                    PatternImage.IsVisible = true;
                }
            }
        }
        ...
        {
            PatternImage.Opacity = e.NewValue;
